...
#CalendarMain {width: 290px;height: 230px;border: 1px solid #ccc;margin:0 auto;margin-top:20px;padding-bottom:10px;}
#title {width: 100%;height: 30px;background-color: #DA8387;}
.selectBtn {font-weight: 900;font-size: 15px;color: #fff;cursor: pointer;text-decoration: none;padding: 4px 10px 4px 10px;}
.selectBtn:hover {background-color: #DC6666;}
...
.currentItem>a {background-color: #DA8387;width: 25px;line-height: 25px;float: left;-webkit-border-radius: 50%;-moz-border-radius: 50%;border-radius: 50%;color: #fff;}
#foots {width: 100%;height: 35px;background-color: #fff;border-top: 1px solid #ccc;margin-top: -1px;}
#footNow {float: right;margin: 10px 78px 0 0;color: #009ad6;font-family: "微软雅黑";font-size:16px;}
